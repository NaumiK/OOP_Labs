...
class ArrayMenu final {
  ...
  msd::vector<FigureGen::TFigureGen *> g_fig_ = {
      new FigureGen::CircleGen(), new FigureGen::ManhattanCircleGen(),
      new FigureGen::EllipseGen(), new FigureGen::ManhattanEllipseGen(),
      new FigureGen::RectangleGen()};
