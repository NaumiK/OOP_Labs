#ifndef LAB4_FIGURES_MANHATTANELLIPSE_HH
#define LAB4_FIGURES_MANHATTANELLIPSE_HH
#include "Figure/IEllipse.hh"
#include "VR2.hh"

namespace Figure {
class ManhattanEllipse final : public IEllipse {
  VR2 O_;
  int32_t F_;
  double alpha_;
  int32_t r_;
...
public:
  ManhattanEllipse(VR2 O, int32_t focal_length, int32_t r, double alpha);

  static ManhattanEllipse CreateViaABNotation(VR2 O, int32_t a_half_axis,
