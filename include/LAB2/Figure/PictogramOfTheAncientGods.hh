#ifndef LAB2_FIGURES_PICTOGRAMOFTHEANCIENTGODS_HH
#define LAB2_FIGURES_PICTOGRAMOFTHEANCIENTGODS_HH
...
namespace Figure {
class PictogramOfTheAncientGods final : public Figure::Rotateable {
  Figure::Circle egn_;
